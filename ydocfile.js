module.exports = {
  ...
  common: {
    // 通用默认配置，包括主页配置等
    title: "ISmart接口管理平台", //page title
    footer:
      '&copy; 2018 <a href="https://ymfe.org">YMFE</a> Team. Build by <a href="http://ued.qunar.com/ydoc/">ydoc</a>&nbsp;', // 通用尾
    home: '<img src="./images/logo_header@2x.png" /> &nbsp;ISmart',
    homeUrl: "./index.html",
    keywords: "api管理,接口管理,接口文档,api文档",
    description:
      "该平台 是高效、易用、功能强大的 api 管理平台，旨在为开发、产品、测试人员提供更优雅的接口管理服务。可以帮助开发者轻松创建、发布、维护 API，YApi 还为用户提供了优秀的交互体验，开发人员只需利用平台提供的接口数据写入工具以及简单的点击操作就可以实现接口的管理。",
  },
  options: {
    foldcode: false,
    markdown: {
      // 对于 markdown 编译器进行统一配置
  ...
  pages: [
    {
      ...
      homepage: {
        ...
        intro: [
          {
            // 首页的正文部分，数组项依次渲染，可重复使用
            title: "为 API 开发者设计的管理平台", // 介绍板块标题
            desc:
              "YApi 让接口开发更简单高效，让接口的管理更具可读性、可维护性，让团队协作更合理。", // 介绍板块描述
          },
          {
            title: "",
            detail: {
              ...
              content: [
                {
                  // 三列布局的内容，每项的key值非必需，但建议每列的key值一致
                  name: "项目管理", // 板块名称
                  src: "./images/intro_page_1.png", // 缩略图
                  desc:
                    "YApi 成熟的团队管理<br>扁平化项目权限配置满足各类企业的需求", // 描述
                },
                {
                  name: "接口管理",
                  src: "./images/intro_page_2.png",
                  desc:
                    "友好的接口文档<br>基于 websocket 的多人协作接口编辑功能和类 postman 测试工具，让多人协作成倍提升开发效率",
                },
                {
                  name: "MockServer",
    ...
    //   },
    {
      ...
      banner: {
        title: "内网部署",
        description:
          "部署 YApi 平台是非常容易的，即便您不懂 nodejs 或者 mongodb",
      },
      compile: "markdown",
      menuLevel: 2,
      content: "./doc/page/manage/build.md",
    ...
    },
    {
      ...
      banner: {
        title: "YApi",
        description:
          "这里列举了 YApi 的历史版本、发布时间及变更记录，帮助你追溯到每个版本的演进过程。",
      },
      compile: "markdown",
      menuLevel: 2,
    ...
    },
    {
      ...
      content:
        "./server/controllers/+(follow|base|group|interface|interfaceCol|log|project|user).js",
      options: {
        type: "interface",
        source: true,
